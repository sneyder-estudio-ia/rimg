...
export const EvaCore = () => {
  ...
  // Efecto visual para simular actualización
  useEffect(() => {
    const interval = setInterval(() => {
      // Pequeña fluctuación aleatoria para dar vida
